#!/usr/bin/env node
// isolation-local-2-1758444190316.test.mjs - Test for isolation-local-2-1758444190316
...
describe('isolation-local-2-1758444190316', () => {
  

  test('should isolation local 2 1758444190316', async () => {
